Lien du git :https://github.com/LucasMonnais/CDataFrame
réalisé par Lucas MONNAIS et Antonin CROQUETTE

Dépot intermédiaire (21/03):
Lors de ce projet il nous est demander de reproduire un CDataFrame. Pour ce faire nous avons utilisé un tableau dynamique qui pointe vers des colonnes.
Pour l'instant le tableau ne supporte que des entiers et nous avons pu implémenter toutes les fonctionnalités de bases :
